      ...
      'data': [
        {
          ...
          'size_bytes': 1258291,
          'uploaded_by_nickname': 'Dylan',
          'created_at': '2026-04-10T09:00:00Z'
        },
        {
          'uuid': 'f2',
          'file_kind': 'reference',
          'original_name': 'API接口文档.md',
      ...
      'data': [
        {
          'id': 'rpt_001',
          'date': '2026-03-22',
          'summary': '今日完成了首页 UI 骨架搭建，包括项目方和团队双首页的差异化布局。需求广场筛选逻辑开发中。',
          'completed_tasks': ['t2'],
